        ...
        content: `
            <div style="text-align: center;">
                ...
                <button onclick="generateQR()" 
                    style="padding: 15px 30px; font-size: 16px; background: #54B9BE; 
        ...
        content: `
            <div style="text-align: center;">
                ...
                <button id="scan-button" onclick="startScanning()" 
                    style="display: inline-block; padding: 12px 24px; background: #54B9BE; 
                ...
                <div style="margin: 15px 0; padding: 15px; background: #f8f9fa; border-radius: 8px; border: 2px solid #e9ecef;">
                    ...
                    <button id="copy-button" onclick="copyToClipboard()" 
                        style="display: none; padding: 8px 16px; background: #54B9BE; color: white; border: none; 
        ...
        initScript: function() {
            ...
            window.copyToClipboard = function() {
                ...
                navigator.clipboard.writeText(window.lastScannedText).then(() => {
                    ...
                    copyButton.style.background = "#54B9BE";
